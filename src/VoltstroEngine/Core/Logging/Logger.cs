...
namespace VoltstroEngine.Core.Logging
{
	public static class Logger
	{
		...
		private static readonly bool LogDebugMessagesToConsole = true;
		...
		public static void EndLogger()
		{
			...
			logStream.WriteLine($"Goodbye! Logger shutdown at {DateTime.Now:hh:mm:ss tt} on day {DateTime.Now:MM-dd}");
		...
		public static void Log(string message, LogVerbosity logVerbosity = LogVerbosity.Info)
		{
			...
			string formattedMessage = $"[{DateTime.Now:hh:mm:ss tt} {logVerbosity}] {message}";
